...
public class Constants {
    ...
    public static final String BlOG_SERVICE = "http://localhost:8080/information-service/api/";
    public static final String PRODUCT_SERVICE = "http://localhost:8080/product-service/api/";
    public static final String COMMON_SERVICE = "http://localhost:8080/common-service/api/";
    public static final String ORDER_SERVICE = "http://localhost:8080/checkout-service/api/";
}
